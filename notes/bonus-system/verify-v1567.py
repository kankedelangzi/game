...
with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verification-cc-bonus-v1567.json", "w") as f:
    json.dump(report, f, ensure_ascii=False, indent=2)

print(f"✅ v1567 稳态核查完成: {passed}/{len(results)} Python独立验算通过")
if failed > 0:
    print(f"❌ 失败项: {failed}")
    sys.exit(1)
else:
