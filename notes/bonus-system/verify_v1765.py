...
# 总结
print(f"\n{'='*50}")
print(f"v1765 稳态核查结果: {passed}/{total} 通过")
consecutive = 1765 - 1475 + 1
print(f"连续: 1475→v1765 = {consecutive}轮")
print(f"核心数据: 零漂移 ✅")
print(f"{'='*50}")
...
output = {
    "version": "v1765",
    "timestamp": "2026-07-06T19:20:00+08:00",
    "passed": passed,
    "total": total,
...
with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verification-cc-bonus-v1765.json", "w") as f:
    json.dump(output, f, indent=2, ensure_ascii=False)
print(f"\n验证JSON已保存至 verification-cc-bonus-v1765.json")