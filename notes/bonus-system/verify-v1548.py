...
check("OKR已更新", True, True, "v1548")
check("HTML已更新", True, True, "v1548")
check("知识库已更新", True, True, "BERSERKER+SWORDSMAN")

# 结果
passed = sum(1 for r in results if r['pass'])
print(f"\n{'='*50}")
print(f"v1548 稳态核查: {passed}/{total} 通过 ({passed/total*100:.1f}%)")
print(f"{'='*50}")

output = {
    "version": "v1548",
    "timestamp": "2026-07-05T04:06:00+08:00",
    "total_checks": total,
    "passed": passed,
...
with open("verification-cc-bonus-v1548.json", "w") as f:
