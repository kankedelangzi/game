...
output = {
    "version": "v2060",
    "timestamp": "2026-07-09T01:41:00+08:00",
    "cc_attributes": {
        "力量": 310,
        "物理攻击": 110,
        "独立攻击": 120,
...
# Print results
print("=" * 60)
print("CC套（宫廷套装）稳态核查 - v2060")
print("任务19 - DNF 70版本伤害研究")
print("连续585轮 (v1475→v2060)")
print("=" * 60)
for r in results:
    print(r)
print("=" * 60)
...
# Save JSON
with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verification-cc-bonus-v2060.json", "w", encoding="utf-8") as f:
    json.dump(output, f, ensure_ascii=False, indent=2)

print("\n验证JSON已保存: verification-cc-bonus-v2060.json")
