...
with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verification-v593.json", "w") as f:
    json.dump(output, f, ensure_ascii=False, indent=2)

print(f"v593: {passed}/{total} passed ({100*passed/total:.1f}%)")
