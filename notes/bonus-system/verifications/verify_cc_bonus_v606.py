...
print(f"稳态核查 v606 | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print("=" * 60)
for r in results:
...
with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verifications/verification-cc-bonus-v606.json", "w") as f:
    json.dump(output, f, indent=2, ensure_ascii=False)
print(f"\nJSON已保存: verification-cc-bonus-v606.json")
