...
# 3. 狂战士百分比收益验证
# ==========================================
berserker_str_base = 728 * 1.40  # 暴走后
...
print(f"稳态核查 v355 | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print("=" * 60)
for r in results:
...
with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verifications/verification-cc-bonus-2026-06-24-v355.json", "w") as f:
    json.dump(output, f, indent=2, ensure_ascii=False)
print(f"\nJSON已保存: verification-cc-bonus-2026-06-24-v355.json")
