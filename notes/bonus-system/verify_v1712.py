...
report = {
    "version": "v1712",
    "timestamp": "2026-07-06T06:49:00+08:00",
    "passed": passed,
    "total": total,
    "rate": f"{passed}/{total}",
    ...
    "po_cc": round(POLE_BREAK_ATK + CC_PHY_ATK),
    ...
    "core_data_drift": "零漂移",
    "continuous_rounds": f"v1475→v1712 = {1712-1475+1}轮"
}

with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verification-cc-bonus-v1712.json", "w") as f:
...
print(f"连续轮次: v1475→v1712 = {1712-1475+1}轮")
if passed == total:
    print("🟢 全部通过，核心数据零漂移")
    sys.exit(0)
else:
