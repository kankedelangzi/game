#!/usr/bin/env python3
"""CC套稳态核查 v595 - 独立交叉验证 2026-06-27 08:54"""
...
with open("/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verification-v595.json", "w") as f:
    json.dump(output, f, ensure_ascii=False, indent=2)

print(f"v595: {passed}/{total} passed ({100*passed/total:.1f}%)")
