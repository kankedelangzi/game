...
results = {"version": "v1647", "timestamp": "2026-07-05T16:20:00+08:00", "checks": [], "summary": {}}
...
with open("notes/bonus-system/verification-cc-bonus-v1647.json", "w") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

# 连续轮次
consecutive = 171  # 1475→v1646=170, v1647=171
print(f"\n✅ 通过: {passed}/{total} | 连续{consecutive}轮(1475→v1647) 100%通过率")
