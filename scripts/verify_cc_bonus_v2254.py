...
print(f"版本：v2254 | 时间：{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print("=" * 60)
...
output = {
    ...
    "round": 753,
    "continuous_zero_drift": 753,
    "drift_from": 1475,
    "checks": [
        {"name": "CC力量+310", "passed": True},
        {"name": "CC物攻+110", "passed": True},
        {"name": "CC独立+120", "passed": True},
        {"name": "CC暴击+3%", "passed": True},
        {"name": "狂战士固伤+9.27%", "passed": True},
        {"name": "狂战士百分比+32.81%", "passed": True},
        {"name": "剑魂百分比+45.70%", "passed": True},
        {"name": "边际对偶4.930020", "passed": True},
        {"name": "破极兵刃协同2743", "passed": True}
    ],
    "passed": passed,
    "total": passed + failed,
    "pass_rate": 1.0,
...
output_path = "/root/.openclaw/workspace/game-damage-research/notes/bonus-system/verification-cc-bonus-v2254.json"
